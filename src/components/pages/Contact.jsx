          ...
          <Card style={contactstyle} id="Contact">
            ...
            <Card.Body>
              <ListGroup
                ...
                style={{
                  borderRadius: "9px",
                  border: "solid, 2px, #9C528B ",
                  fontSize: "medium",
                }}
              >
                <ListGroup.Item style={{}}>
                  <img src="/images/gmail.webp" style={iconstyle}></img>{" "}
                  <Email />
                </ListGroup.Item>
                <ListGroup.Item style={{}}>
                  <Card.Link
                    ...
                    target="_blank"
                  >
                    <img src="/images/linkedin.png" style={iconstyle}></img>{" "}
                    LinkedIn
                  </Card.Link>
                </ListGroup.Item>
                <ListGroup.Item style={{}}>
                  <Card.Link href="https://github.com/hestrain" target="_blank">
                    <img src="/images/github.png" style={iconstyle}></img>{" "}
                    Github
                  </Card.Link>
                </ListGroup.Item>
              </ListGroup>
        ...
        <Col md="8">
          <Card style={contactstyle}>
            <Card.Title style={titlestyle}>
              Or, contact me directly with the form below
            </Card.Title>
